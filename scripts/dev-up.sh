...
ORG1_BASE_RATE="${ORG1_BASE_RATE:-1000000}"
ORG1_MARKUP="${ORG1_MARKUP:-200000}"
ORG2_BASE_RATE="${ORG2_BASE_RATE:-1500000}"
ORG2_MARKUP="${ORG2_MARKUP:-300000}"
ORG3_BASE_RATE="${ORG3_BASE_RATE:-1200000}"
ORG3_MARKUP="${ORG3_MARKUP:-250000}"
ORG4_BASE_RATE="${ORG4_BASE_RATE:-1800000}"
ORG4_MARKUP="${ORG4_MARKUP:-350000}"
